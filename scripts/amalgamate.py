...
def generate_amalgamation():
    ...
    lines.append('')
    lines.append('// ============================================================================')
    lines.append('// FFT Library')
    lines.append('// ============================================================================')
    lines.append('')
    lines.append('#ifdef USE_MKL')
    lines.append('#include <mkl_dfti.h>')
    lines.append('#define fftw_complex MKL_Complex16')
    lines.append('#define fftw_plan DFTI_DESCRIPTOR_HANDLE')
    lines.append('#else')
    lines.append('#include <fftw3.h>')
    lines.append('#endif')
    lines.append('')
    lines.append('// ============================================================================')
